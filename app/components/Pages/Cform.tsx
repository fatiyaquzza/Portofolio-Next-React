...
export default function Cform() {
  ...
  return (
    <div
      id="contact"
      className="mx-auto h-screen bg-[#131320] flex justify-center items-center px-4"
    >
      <div></div>
      <div className="flex flex-col lg:flex-row p-8 rounded-xl shadow-lg max-w-5xl w-full">
        ...
        <div className="lg:w-1/2 pl-0 lg:pl-8">
          <Form action="/send-message" className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
              <div className="flex flex-col w-full sm:w-1/2">
                ...
                <input
                  ...
                  name="name"
                  required
                  className="bg-[#2D2D3A] border border-transparent text-white px-4 py-3 rounded focus:outline-none focus:ring-2 focus:ring-purple-600 placeholder-gray-500"
            ...
            <div className="flex flex-col sm:flex-row sm:space-x-4 space-y-4 sm:space-y-0">
              <div className="flex flex-col w-full sm:w-1/2">
                <label htmlFor="phone" className="text-gray-400 mb-1 text-sm">
                  Phone
                </label>
                <input
                  type="tel"
            ...
            <div className="flex flex-col">
              ...
              <textarea
                ...
                rows={4}
                required
                className="bg-[#2D2D3A] border border-transparent text-white px-4 py-3 rounded resize-none focus:outline-none focus:ring-2 focus:ring-purple-600 placeholder-gray-500"
            ...
            <button
              type="submit"
              className="w-full bg-[#2D2D3A] hover:bg-[#3A3A4A] text-white font-semibold py-3 px-4 rounded transition-colors text-lg"
            >
              Send message
            </button>
          </Form>
